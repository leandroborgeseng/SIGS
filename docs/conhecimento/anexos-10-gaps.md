...
> **Superado em parte** por `docs/requisitos/gap-analysis.md` (TR × e-SUS por módulo, 2026-08-10).  
> Este anexo permanece como evidência do inventário por *hits de nome* na build 5.5.24.
