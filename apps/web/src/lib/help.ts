...
export const HELP_ARTICLES: HelpArticle[] = [
  ...
  },
  {
    ...
    body: `Em /odonto escolha paciente, profissional e lotação. Na ficha, CIAP/CID com busca, condutas LEDI e painel que valida ~1s após editar. Finalizar e faturar exige zero BLOCKER. Pós-fechamento: fila /faturamento/odonto (quando houver prontas Siaps, atalho para exportar ZIP) e lote /faturamento/lote/fao. Anular só rascunho.`,
  },
  {
    id: 'odonto.stub',
    title: 'Odontologia',
    ...
    version: '0.4.0',
    updatedAt: '2026-08-12',
    summary: 'Alias — ver odonto.atendimento.',
    body: `Fluxo atual: /odonto (lotação) → /odonto/[id] → /faturamento/odonto. Ajuda detalhada: odonto.atendimento.`,
  },
  {
    id: 'faturamento.hub',
    ...
    version: '0.2.0',
    updatedAt: '2026-08-12',
    summary: 'Hub de fila odonto e lotes LEDI.',
    body: `Tela /faturamento: atalhos para fila odonto, lotes FAO/FAI/PROC e Produção. Na fila odonto, fichas prontas levam ao lote FAO para exportar ZIP. Nav em sanfona no grupo Faturamento & Validação.`,
  },
  {
    id: 'odonto.lote-ledi',
    ...
    body: `Em Faturamento → Lote LEDI FAO (/faturamento/lote/fao): (1) envie XMLs ou ZIP; (2) veja o funil Siaps/Previne; (3) corrija alertas (lote ou ficha); (4) quando houver prontas Siaps, use Exportar / baixar ZIP — preferir “só conformes”; dry-run simula auto-correção; relatório .md fecha a análise. Alias antigo: /odonto/lote.`,
  },
  {
    id: 'ad.stub',
