...
export const HELP_ARTICLES: HelpArticle[] = [
  ...
  },
  {
    ...
    version: '1.2.0',
    updatedAt: '2026-08-16',
    summary: 'Cascata Imunobiológico → Estratégia → Dose; estoque/frio MVP.',
    body: `Estratégia Especial exige CBO e CID-10. BCG exige informar se é comunicante de hanseníase. A aplicação gera lote de produção LEDI. Se houver estoque do mesmo lote na unidade (aba Estoque / frio), a quantidade é baixada; anulação devolve. Faixa °C alvo é declarada — não há monitoramento contínuo de geladeira. A lista do dia respeita a unidade selecionada.`,
  },
  {
  ...
  },
  {
    ...
    body: `Selecione 1–99 cidadãos, modalidade AD1/AD2/AD3, turno, tipo LEDI, condições e CIAP/CID (busca). Use Preflight antes de Finalizar — lote home_care traz N atendimentosDomiciliares e qty BPA = N.`,
  },
  {
    id: 'producao.ledi',
