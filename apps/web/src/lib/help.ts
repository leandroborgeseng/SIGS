...
export const HELP_ARTICLES: HelpArticle[] = [
  ...
  },
  {
    ...
    summary: 'Abertura com lotação, ficha LEDI, Tela C e fila /faturamento/odonto.',
    body: `Em /odonto escolha paciente, profissional e lotação — ou abra a partir de /odonto/agenda (slot do dia). Na ficha, CIAP/CID com busca, condutas LEDI e painel que valida ~1s após editar. Finalizar e faturar exige zero BLOCKER. Pós-fechamento: fila /faturamento/odonto e lote /faturamento/lote/fao.`,
  },
  {
    id: 'odonto.agenda',
