...
export const HELP_ARTICLES: HelpArticle[] = [
  ...
  },
  {
    ...
    body: `Em /odonto escolha paciente, profissional e lotação. Na ficha, CIAP/CID com busca, condutas LEDI e painel que valida ~1s após editar. Finalizar e faturar exige zero BLOCKER. Pós-fechamento: fila /faturamento/odonto e lote /faturamento/lote/fao. Anular só rascunho.`,
  },
  {
    id: 'odonto.stub',
    title: 'Odontologia',
  ...
  },
  {
    ...
    body: `Tela /faturamento: atalhos para fila odonto, lotes FAO/FAI/PROC e Produção. Nav em sanfona no grupo Faturamento & Validação.`,
  },
  {
    id: 'odonto.lote-ledi',
    ...
    body: `Em Faturamento → Lote LEDI FAO (/faturamento/lote/fao): (1) envie XMLs; (2) veja o funil Siaps/Previne; (3) cada alerta mostra Por quê e Como corrigir; (4) corrija em massa ou ficha a ficha. Alias antigo: /odonto/lote.`,
  },
  {
    id: 'ad.stub',
